...
g++ hello.pb.o hello.grpc.pb.o  -ggdb -o wrap server.cc -std=c++1z -rdynamic -pthread -static-libstdc++ -Wl,-non_shared  -lprotobuf -pthread -lz -lgrpc++ -lprotobuf -lgrpc -lz -lssl -lcrypto -llzma -Wl,-call_shared -lgrpc++_reflection -lpthread -ldl -Wl,-Bsymbolic-functions -o s_server
